...
OBJDIR := funcs
OBJS := findball.o helpers.o ishappynum.o longcommonprefix.o mergesort.o \
       multiplystrings.o removeNthFromEnd.o spiralorder.o
...
clean:
	rm *.o funcs/*.o ./leetcode

leetcode: $(OBJS)
	$(CC) $(CFLAGS) $(WARNINGS) -o leetcode leetcode_main.c $(OBJS)
